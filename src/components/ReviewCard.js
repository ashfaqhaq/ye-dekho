...
function ReviewCard(props) {
  ...
  function showSpoiler(id) {
    ...
    //   data(data.find(item=>item.id))
    var obj =(data.find(item=>item.id))
    obj.isSpoiler = false;
   
    console.log(obj)
    // setData((prevState)=>[...prevState,{[obj.isSpoiler]:true}])
        ...
        return (
          <Grid.Row>
            ...
            >
              ...
              <Card fluid>
                {data?.isSpoiler && <Button onClick={()=>showSpoiler(data.id)}> show spoiler</Button>}
                {/* <Label
                      as="a"
                      color="blue"
                      ribbon="right"
                ...
                <Card.Content extra>
                  ...
                  <Button floated="right" onClick={()=>open(data.id)} negative>
